...
class Config:
    ...
    GCP_RPC_URL = "https://blockchain.googleapis.com/v1/projects/advance-display-433704-a6/locations/us-central1/endpoints/ethereum-mainnet/rpc?key=YOUR_API_KEY" # Replace with your actual GCP RPC URL and Key

    # PYUSD Contract Address (Ensure this is correct)
    PYUSD_CONTRACT_ADDRESS = "0x6b4c7a5e3f0b99c74a6b515f1915ad0f23844d83" # From cong_real.py

    # Entity Data File Path
    ENTITY_DATA_FILE = os.path.join(os.path.dirname(__file__), 'data', 'entity_data.json')
